package dev.amargos.zenithstudios.shared.variables;

import java.util.Collection;
import java.util.HashSet;

public class Variables {
    private static final String DEFAULT_MOTD = "ZenithMC fantastic MOTD\nNo MOTD has been specified!";
    ...
    public String getMOTD(final int maxPlayers, final int onlinePlayers) {
        ...
        return motds[randomIndex].replace("%max_players%", String.valueOf(maxPlayers)).replace("%online_players%",
